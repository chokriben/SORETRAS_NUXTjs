      ...
      <v-card>
        <v-form>
          ...
          <v-row v-if="typeecol === 'pub'" class="form">
            ...
            <v-col cols="12" sm="6">
              ...
              <select v-model="classe" class="forms" autocomplete>
                ...
                <option value="السنة الثانة">السنة الثانة</option>
                ...
                <option value="السنة الرابعة ثانوي">السنة الرابعة ثانوي</option>
          ...
          <v-row v-if="typeecol === 'priv'" class="form">
            ...
            <v-col cols="12" sm="6">
              <v-text-field v-model="id_unique" color="primary" label="رقم بطاقة التعريف الوطنية *"
                prepend-inner-icon="mdi-school" disabled></v-text-field>
            </v-col>
            <v-col cols="12" sm="6">
...
const id_unique = ref(urlParams.get('id_unique'));
const typ_yes = ref("");
const image = ref("");

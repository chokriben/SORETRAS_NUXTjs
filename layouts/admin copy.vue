      ...
      <v-list v-model:opened="open">
        ...
        <v-list-group value="Etablissements">
          ...
          <NuxtLink to="/admin/etablissements"><v-list-item prepend-icon="mdi-school" title="Etablissements"
              link></v-list-item></NuxtLink>
          <NuxtLink to="/admin/typeetablissement"><v-list-item prepend-icon="mdi-school" title="typeetablissement"
              link></v-list-item></NuxtLink>
        ...
        <v-list-group value="Abonnements">
          ...
          <NuxtLink to="/admin/abonnementR" class="custom-link" link>
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-title class="custom-title">abonnement Régional</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </NuxtLink>
          ...
          <NuxtLink to="/admin/abonnementU" class="custom-link" link>
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-title class="custom-title">abonnement Urbain</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </NuxtLink>
...
-->
        ...
        <v-list-group value="Siége">
          ...
          <NuxtLink to="/admin/circuit"><v-list-item prepend-icon="mdi-train-variant" title="circuit" link></v-list-item>
          </NuxtLink>
